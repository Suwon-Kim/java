...
public class Appoint_GUI extends JFrame {
	...
	// ++++++++++++++++++++
	public Appoint_GUI(Socket sock, ObjectOutputStream oos, ObjectInputStream ois, String name,
		...
		this.users = users;
		this.title2 = title2;
		System.out.println("Appoint_GUI"+ users);
		init();
		setDisplay();
		addListeners();
		showFrame();
	...
	private void addListeners() {
		...
		ActionListener alistener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (obj == btnAppoint) {
					// ++++++++++++++++++++
					System.out.println("다음 방장 임명");
						SendData send = new SendData(141, userName ,title2);
