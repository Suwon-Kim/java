...
public class Invite_GUI extends JFrame {
	...
	// ++++++++++++++++++++
	public Invite_GUI(Socket sock, ObjectOutputStream oos, ObjectInputStream ois, String name,
		...
		this.title2 = title2;
		System.out.println("Invite_GUI"+ waitUserList);
		init();
		setDisplay();
		addListeners();
		showFrame();
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (obj == btnInvite) {
					...
					System.out.println("초대");
						SendData send = new SendData(170,userName,title2,name);
						System.out.println("초대할때 방번호 170 " + title2);
						try {
