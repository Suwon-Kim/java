...
public class ChatRoom_Setting_GUI extends JFrame {
	...
	public ChatRoom_Setting_GUI(Socket sock, ObjectOutputStream oos,String title) {
		this.title = title;
		this.oos = oos ; 
		init();
		setDisplay();
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (obj == btnCancel) {
					...
					if(tfRoomName.getText().equals("")){
						...
						SendData sd = new SendData(130,title, changeTitle, maxPeople);
						try {
							oos.writeObject(sd);
							oos.flush();
							oos.reset();
