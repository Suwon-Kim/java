			...
			try {
				...
				if ((obj = ois.readObject()) != null) {
					...
					if (code == ServerProtocol.ENTRANCE_SUCCESS) {
						...
						System.out.println("start userlist" + watingRoom.getWatingRoomUserList());
						System.out.println("start getAllChatRoomList : " + watingRoom.getAllChatRoomList());
