...
public class CreateRoom_GUI extends JFrame {
	...
	public CreateRoom_GUI(Socket sock, ObjectOutputStream oos, ObjectInputStream ois, String name) {
		this.sock = sock;
		this.oos = oos;
		this.ois = ois;
		this.name = name;
